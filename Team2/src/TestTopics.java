...
//		Topic cul = new Topic(article1, 1, 0, null);
//		cul.addArticle(article2, 0,null);
//		cul.addArticle(article3, 0,null);
//		cul.addArticle(article4, 0,null);
//		cul.addArticle(article5, 0,null);
